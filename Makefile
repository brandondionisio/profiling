##############################################################
 ...
 #           Date: 04/22/24
 #
 #     Summary: Makefile that includes build rules for um
 #              
##############################################################
...
LDFLAGS = -O2 -L/comp/40/build/lib -L/usr/sup/cii40/lib64 -lcii40-O2
...
LDLIBS = -lum-dis -lcii40-O2 -lm -lrt
